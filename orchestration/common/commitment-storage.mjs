...
const WHOLE_STATES = ['strikePrice', 'bundlePrice', 'shortfallThreshold', 'numberOfConsecutivePeriodsForShortfall', 'surplusThreshold', 'numberOfConsecutivePeriodsForSurplus', 'dailyInterestRate', 'startDateOfContract', 'expiryDateOfContract', 'volumeShare', 'sequenceNumberInterval', 'latestShortfallSequenceNumber', 'latestSurplusSequenceNumber', 'shortfalls_index', 'surpluses_index_1', 'generatorCfdNetPosition_billNumber', 'offtakerCfdNetPosition_billNumber', 'generatorInterest_billNumber', 'offtakerInterest_billNumber', 'offtakerNegativePriceCharges_billNumber', 'generatorNegativePriceCharges_billNumber', 'shortfallPositiveChargeSum', 'shortfallNegativeChargeSum', 'shortfallIndex', 'shortfallPositiveCharges_billNumber', 'shortfallNegativeCharges_billNumber', 'surplusPositiveChargeSum', 'surplusNegativeChargeSum', 'surplusIndex', 'surplusPositiveCharges_billNumber', 'surplusNegativeCharges_billNumber'];
// structure for SMT
