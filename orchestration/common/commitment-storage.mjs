...
const WHOLE_STATES = ['strikePrice', 'bundlePrice', 'shortfallThreshold', 'numberOfConsecutivePeriodsForShortfall', 'surplusThreshold', 'numberOfConsecutivePeriodsForSurplus', 'dailyInterestRate', 'expiryDateOfContract', 'volumeShare', 'sequenceNumberInterval', 'latestShortfallSequenceNumber', 'latestSurplusSequenceNumber', 'shortfalls_index', 'surplus_tempSurplusIndex', 'generatorCharges_billNumber', 'offtakerCharges_billNumber', 'generatorInterest_billNumber', 'offtakerInterest_billNumber', 'negativePriceCharges_billNumber', 'shortfallChargeSum', 'shortfallIndex', 'shortfallCharges_billNumber', 'surplusChargeSum', 'surplusIndex', 'surplusCharges_billNumber'];
// structure for SMT
